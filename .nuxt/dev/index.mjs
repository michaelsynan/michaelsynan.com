globalThis._importMeta_={url:import.meta.url,env:process.env};import 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/node-fetch-native@1.0.1/node_modules/node-fetch-native/dist/polyfill.mjs';
import { Server } from 'node:http';
import { tmpdir } from 'node:os';
import { join as join$1 } from 'node:path';
import { mkdirSync } from 'node:fs';
import { parentPort, threadId } from 'node:worker_threads';
import { provider, isWindows } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/std-env@3.3.1/node_modules/std-env/dist/index.mjs';
import { eventHandler, setHeaders, sendRedirect, defineEventHandler, handleCacheHeaders, createEvent, getRequestHeader, getRequestHeaders, setResponseHeader, getQuery, getCookie, createError, createApp, createRouter as createRouter$1, lazyEventHandler, toNodeListener } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/h3@1.1.0/node_modules/h3/dist/index.mjs';
import { createRenderer } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/vue-bundle-renderer@1.0.0/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import devalue from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/@nuxt+devalue@2.0.0/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { renderToString } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/vue@3.2.45/node_modules/vue/server-renderer/index.mjs';
import { withoutBase, parseURL, withQuery, joinURL, withLeadingSlash, withoutTrailingSlash, isRelative } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/ufo@1.0.1/node_modules/ufo/dist/index.mjs';
import destr from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/destr@1.2.2/node_modules/destr/dist/index.mjs';
import { snakeCase, kebabCase, pascalCase, camelCase } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/scule@1.0.0/node_modules/scule/dist/index.mjs';
import { createFetch as createFetch$1, Headers } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/ofetch@1.0.0/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unenv@1.0.2/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/hookable@5.4.2/node_modules/hookable/dist/index.mjs';
import { hash } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/ohash@1.0.0/node_modules/ohash/dist/index.mjs';
import { createStorage, prefixStorage } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unstorage@1.0.1/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unstorage@1.0.1/node_modules/unstorage/dist/drivers/fs.mjs';
import defu from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/defu@6.1.2/node_modules/defu/dist/defu.mjs';
import { toRouteMatcher, createRouter } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/radix3@1.0.0/node_modules/radix3/dist/index.mjs';
import { extname, join } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/pathe@1.0.0/node_modules/pathe/dist/index.mjs';
import { unified } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unified@10.1.2/node_modules/unified/index.js';
import { toString } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/mdast-util-to-string@3.1.0/node_modules/mdast-util-to-string/index.js';
import { preprocess } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/micromark@3.1.0/node_modules/micromark/dev/lib/preprocess.js';
import { postprocess } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/micromark@3.1.0/node_modules/micromark/dev/lib/postprocess.js';
import { stringifyPosition } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unist-util-stringify-position@3.0.2/node_modules/unist-util-stringify-position/index.js';
import { markdownLineEnding, markdownSpace } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/micromark-util-character@1.1.0/node_modules/micromark-util-character/dev/index.js';
import { push, splice } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/micromark-util-chunked@1.0.0/node_modules/micromark-util-chunked/dev/index.js';
import { resolveAll } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/micromark-util-resolve-all@1.0.0/node_modules/micromark-util-resolve-all/index.js';
import remarkEmoji from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-emoji@3.0.2/node_modules/remark-emoji/index.js';
import rehypeSlug from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/rehype-slug@5.1.0/node_modules/rehype-slug/index.js';
import remarkSqueezeParagraphs from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-squeeze-paragraphs@5.0.1/node_modules/remark-squeeze-paragraphs/index.js';
import rehypeExternalLinks from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/rehype-external-links@2.0.1/node_modules/rehype-external-links/index.js';
import remarkGfm from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-gfm@3.0.1/node_modules/remark-gfm/index.js';
import rehypeSortAttributeValues from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/rehype-sort-attribute-values@4.0.0/node_modules/rehype-sort-attribute-values/index.js';
import rehypeSortAttributes from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/rehype-sort-attributes@4.0.0/node_modules/rehype-sort-attributes/index.js';
import rehypeRaw from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/rehype-raw@6.1.1/node_modules/rehype-raw/index.js';
import remarkMDC, { parseFrontMatter } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-mdc@1.1.3/node_modules/remark-mdc/dist/index.mjs';
import remarkParse from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-parse@10.0.1/node_modules/remark-parse/index.js';
import remark2rehype from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/remark-rehype@10.1.0/node_modules/remark-rehype/index.js';
import { all } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/mdast-util-to-hast@12.2.4/node_modules/mdast-util-to-hast/index.js';
import { detab } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/detab@3.0.2/node_modules/detab/index.js';
import { u } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unist-builder@3.0.0/node_modules/unist-builder/index.js';
import { encode } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/mdurl@1.0.1/node_modules/mdurl/index.js';
import slugify from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/slugify@1.6.5/node_modules/slugify/slugify.js';
import { position } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unist-util-position@4.0.3/node_modules/unist-util-position/index.js';
import htmlTags from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/html-tags@3.2.0/node_modules/html-tags/index.js';
import { visit } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unist-util-visit@4.1.1/node_modules/unist-util-visit/index.js';
import { BUNDLED_LANGUAGES, BUNDLED_THEMES, getHighlighter } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/shiki-es@0.1.2/node_modules/shiki-es/dist/shiki.node.mjs';
import consola from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/unenv@1.0.2/node_modules/unenv/runtime/npm/consola.mjs';

const _runtimeConfig = {"app":{"baseURL":"/","buildAssetsDir":"/_nuxt/","cdnURL":""},"nitro":{"envPrefix":"NUXT_","routeRules":{"/__nuxt_error":{"cache":false}}},"public":{"siteName":"Michael Synan","content":{"locales":[],"experimental":{"stripQueryParameters":false,"clientDB":false},"api":{"baseURL":"/api/_content"},"navigation":{"fields":["layout"]},"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"highlight":false,"wsUrl":"ws://localhost:4009/","documentDriven":{"page":true,"navigation":true,"surround":true,"globals":{},"layoutFallbacks":["theme"],"injectPage":true},"anchorLinks":{"depth":4,"exclude":[1]}}},"content":{"cacheVersion":2,"cacheIntegrity":"kc4UzpZUjI","transformers":[],"base":"","api":{"baseURL":"/api/_content"},"watch":{"ws":{"port":{"port":4000,"portRange":[4000,4040]},"hostname":"localhost","showURL":false}},"sources":{},"ignores":["\\.","-"],"locales":[],"highlight":false,"markdown":{"tags":{"p":"prose-p","a":"prose-a","blockquote":"prose-blockquote","code-inline":"prose-code-inline","code":"prose-code","em":"prose-em","h1":"prose-h1","h2":"prose-h2","h3":"prose-h3","h4":"prose-h4","h5":"prose-h5","h6":"prose-h6","hr":"prose-hr","img":"prose-img","ul":"prose-ul","ol":"prose-ol","li":"prose-li","strong":"prose-strong","table":"prose-table","thead":"prose-thead","tbody":"prose-tbody","td":"prose-td","th":"prose-th","tr":"prose-tr"},"anchorLinks":{"depth":4,"exclude":[1]},"remarkPlugins":{},"rehypePlugins":{}},"yaml":{},"csv":{"delimeter":",","json":true},"navigation":{"fields":["layout"]},"documentDriven":true,"experimental":{"clientDB":false,"stripQueryParameters":false}}};
...
storage.mount('content:source:content', unstorage_47drivers_47fs({"name":"content:source:content","driver":"fs","base":"/home/mikey/git/michaelsynancom/content","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache:content', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mikey/git/michaelsynancom/.nuxt/content-cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mikey/git/michaelsynancom","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mikey/git/michaelsynancom/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mikey/git/michaelsynancom/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","base":"/home/mikey/git/michaelsynancom/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
  ...
  parse: async (_id, content) => {
    ...
    if (typeof content === "string") {
      if (_id.endsWith("json5")) {
        parsed = (await import('file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/json5@2.2.2/node_modules/json5/lib/index.js').then((m) => m.default || m)).parse(content);
...
const _bjkYv4 = defineEventHandler(async (event) => {
...
const _tapgc8 = defineEventHandler(async (event) => {
...
const _W7O3LR = defineEventHandler(async (event) => {
  const query = getContentQuery(event);
...
const _lazy_gGKGMm = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_gGKGMm, lazy: true, middleware: false, method: undefined },
  ...
  { route: '/api/_content/cache.json', handler: _tapgc8, lazy: false, middleware: false, method: "get" },
  ...
  { route: '/**', handler: _lazy_gGKGMm, lazy: true, middleware: false, method: undefined }
];
...
const getClientManifest = () => import('/home/mikey/git/michaelsynancom/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getStaticRenderedHead = () => Promise.resolve().then(function () { return _virtual__headStatic$1; }).then((r) => r.default || r);
const getServerEntry = () => import('/home/mikey/git/michaelsynancom/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
...
const _virtual__headStatic = {"headTags":"<meta charset=\"utf-8\">\n<meta name=\"viewport\" content=\"width=device-width, initial-scale=1\">\n<meta name=\"title\" content=\"THIS IS THE SITEWIDE TITLE\">","bodyTags":"","bodyTagsOpen":"","htmlAttrs":"","bodyAttrs":""};
