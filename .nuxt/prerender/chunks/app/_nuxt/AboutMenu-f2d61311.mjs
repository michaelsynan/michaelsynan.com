...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "relative text-stone-500" }, _attrs))}><div><button class="${ssrRenderClass([{ "text-stone-200": isOpen2.value }, "px-0 md:px-1 hover:text-stone-200 transition ease-in-out"])}">Contact ${ssrInterpolate(isOpen2.value ? "-" : "+")}</button><span class="px-2">|</span><button class="${ssrRenderClass([{ "text-stone-200": isOpen1.value }, "px-0 md:px-1 hover:text-stone-200 transition ease-in-out"])}">Certifications ${ssrInterpolate(isOpen1.value ? "-" : "+")}</button><span class="px-2">|</span>`);
...
//# sourceMappingURL=AboutMenu-f2d61311.mjs.map
