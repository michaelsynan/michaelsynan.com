import { mergeProps, unref, useSSRContext } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/vue@3.2.45/node_modules/vue/index.mjs';
...
import { Icon } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/@iconify+vue@4.0.2/node_modules/@iconify/vue/dist/iconify.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "pt-4 text-stone-200" }, _attrs))} data-v-92bd7802><a href="https://mstdn.social/@letsbecomehuman" target="_blank" data-v-92bd7802>`);
      _push(ssrRenderComponent(unref(Icon), {
        icon: "mdi:mastodon",
        class: "inline p-1 text-stone-300 hover:text-gray-100 big-icon"
      }, null, _parent));
      _push(`</a><a href="https://github.com/michaelsynan" target="_blank" data-v-92bd7802>`);
      _push(ssrRenderComponent(unref(Icon), {
        icon: "mdi:github",
        class: "inline p-1 text-stone-300 hover:text-gray-100 big-icon"
      }, null, _parent));
      _push(`</a><a href="https://www.linkedin.com/in/hellomichaelsynan/" target="_bank" data-v-92bd7802>`);
      _push(ssrRenderComponent(unref(Icon), {
        icon: "mdi:linkedin",
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-92bd7802"]]);

export { __nuxt_component_1 as default };
//# sourceMappingURL=socials-ca94a81a.mjs.map
