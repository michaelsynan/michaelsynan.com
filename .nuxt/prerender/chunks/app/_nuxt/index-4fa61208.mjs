...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "container w-1/2 pt-20 mx-auto text-slate-200" }, _attrs))}><h1 class="text-white-700">All tags page</h1><p>Whatever...</p></div>`);
}
...
//# sourceMappingURL=index-4fa61208.mjs.map
