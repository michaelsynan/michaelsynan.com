import { useSSRContext, defineAsyncComponent, unref, mergeProps } from 'file:///home/mikey/git/michaelsynancom/node_modules/.pnpm/vue@3.2.45/node_modules/vue/index.mjs';
...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-abca17e4.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-f4763687.mjs').then((r) => r.default || r));
...
//# sourceMappingURL=error-component-6714da29.mjs.map
